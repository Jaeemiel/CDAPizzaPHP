...
<div class="container py-5" style="max-width: 620px;">
    ...
    <div class="form-card">
        <form action="<?= $actionUri ?>" method="POST">
            ...
            <!-- Date & heure -->
            <div class="mb-3">
                <label class="form-label">Date et heure <span style="color:var(--cyan)">*</span></label>
                <input type="date" name="date_heure" class="form-control" value="<?= escape($commande->date_heure)?>" />
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if ($action == 'create'): ?>
                    <div class="statut-display">
                        ...
                        <span class="statut-badge">Payer</span>
                    </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-6">
                    ...
                    <input type="number" name="Montant" class="form-control" value="<?= escape($commande->date_fin)?>" readonly/>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="categorie" class="form-select">
                    <option disabled <?= !$commande->categorie_id ? 'selected' : '' ?>> Choisir une catégorie </option>
                    <?php foreach ($categories as $categorie): ?>
                        <option value="<?= $categorie->id ?>"
                            <?= ($commande->categorie_id == $categorie->id) ? 'selected' : '' ?>>
